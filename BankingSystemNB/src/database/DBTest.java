...
public class DBTest {
			...
			CCard newCard = new CCard(90211, 4, 9.9, 100, 50, 50, "1900-12-13", "No Penalty");
			...
			Loan newLoan = new Loan(90211, 9999, "Short", 9.9, 120.00, 10000, "2014-11-10", 9000, true, "2010-01-01");
